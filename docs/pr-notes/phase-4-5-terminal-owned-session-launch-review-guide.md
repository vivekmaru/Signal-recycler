...
The design explicitly keeps `sr chat` as future terminal UX and rejects `sr codex` as the first slice because launching an opaque vendor TUI would weaken Signal Recycler's context ownership.
